...
auto posreset=[&]() {
    ...
    */    
    ...
    robot->turnToHeading(225, 1600,{.direction=AngularDirection::CW_CLOCKWISE});
    waittildone();
    //drive across square
    piddrive(24*sqrt(2)-0.5, 1700);
    //turn to face 270, MAY NEED TO CHANGE
    robot->turnToHeading(266, 1300,{.direction=AngularDirection::CW_CLOCKWISE});
    waittildone();
    //drive across to other side
    piddrive(26.5,1500);
    robot->turnToHeading(266,700);
    waittildone();
    piddrive(28.5,1750);
    piddrive(-2.5, 900);
